...
function(setup_arduino_target TARGET_NAME BOARD_ID ALL_SRCS ALL_LIBS COMPILE_FLAGS LINK_FLAGS)
  ...
  # Display target size
  add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
      COMMAND racoon size "${CMAKE_CURRENT_SOURCE_DIR}"
...
function(generate_cpp_from_sketch MAIN_SKETCH_PATH SKETCH_SOURCES SKETCH_CPP)
    file(WRITE ${SKETCH_CPP} "// automatically generated by racoon\n")
...
if (NOT ARDUINO_INITIALIZED)
  ...
  execute_process(COMMAND racoon cmake ${CMAKE_CURRENT_SOURCE_DIR} -o${TOOLCHAIN_FILE_PATH})
